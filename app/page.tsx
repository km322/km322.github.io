...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="relative z-5 min-h-screen bg-background/20 backdrop-blur-sm p-3 sm:p-4 md:p-6 lg:p-12">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 md:gap-6">
            ...
            {/* Main Content */}
            <main className="flex-1 bg-card/40 rounded-xl md:rounded-2xl border border-border overflow-hidden">
              {/* Navigation */}
